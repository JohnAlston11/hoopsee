    ...
    render(){
        return(
            <div>
                ...
                <a href="/courts/manhattan" ><div style={{backgroundImage:`url('${m}')`}} id='mh' className='icons' > MANHATTAN </div></a>
                <a href="/courts/queens" ><div style={{backgroundImage:`url('${q}')`}} id='q' className='icons' > QUEENS </div></a>
                <a href="/courts/other" ><div style={{backgroundImage:`url('${nyc}')`}} id='other' className='icons' > OTHER </div></a>
            </div>
        )
    }
}